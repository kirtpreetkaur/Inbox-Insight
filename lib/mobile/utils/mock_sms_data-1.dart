// lib/mobile/utils/mock_sms_data.dart
...
class Message {
  ...
  final String text;
  final DateTime time;
  final String category; // one of the 12 categories
  final IconData icon;
...
class MockSmsData {
  static List<Message> loadAll() {
    ...
    return [
      ...
      // Utilities / Security / OTP (grouped)
      Message(
        id: 'util1',
        sender: 'ElectricCo',
  ...
  // helper: group by category counts for digest
